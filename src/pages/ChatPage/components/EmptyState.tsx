                ...
                <CardContent className="p-4 sm:p-6 relative min-h-[80px]">
                  <div className="flex items-start gap-3">
                    ...
                    <div className="flex-1">
                      <div className="font-semibold text-sm sm:text-base mb-1 text-[var(--text)] group-hover:text-[var(--primary)] transition-colors">{item.title}</div>
                      <div className="text-xs sm:text-sm text-[var(--text-secondary)] opacity-80">{item.subtitle}</div>
                    </div>
                  </div>
                </CardContent>
              </Card>
