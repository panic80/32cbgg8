...
const metricsSample: PerformanceMetrics = {
  ...
  quality: {
    ...
    contextSupport: { count: 5, mean: 0.88, min: 0.85, max: 0.9, p50: 0.87, p75: 0.89, p95: 0.9, p99: 0.9, ratePerMinute: 0, windowSize: 5, recent: [] },
    answerToContext: { count: 5, mean: 1.2, min: 1.1, max: 1.3, p50: 1.2, p75: 1.22, p95: 1.28, p99: 1.3, ratePerMinute: 0, windowSize: 5, recent: [] },
    ...
    answerTokens: { count: 5, mean: 200, min: 160, max: 240, p50: 190, p75: 210, p95: 230, p99: 240, ratePerMinute: 0, windowSize: 5, recent: [] },
    sourceTokens: { count: 5, mean: 260, min: 200, max: 320, p50: 250, p75: 270, p95: 310, p99: 320, ratePerMinute: 0, windowSize: 5, recent: [] },
    sourceCount: { count: 5, mean: 3, min: 2, max: 4, p50: 3, p75: 3.5, p95: 4, p99: 4, ratePerMinute: 0, windowSize: 5, recent: [] },
    retrievalScores: {
      avg: { count: 5, mean: 0.72, min: 0.6, max: 0.85, p50: 0.7, p75: 0.75, p95: 0.83, p99: 0.85, ratePerMinute: 0, windowSize: 5, recent: [] },
      max: { count: 5, mean: 0.92, min: 0.9, max: 0.95, p50: 0.91, p75: 0.93, p95: 0.95, p99: 0.95, ratePerMinute: 0, windowSize: 5, recent: [] },
      min: { count: 5, mean: 0.42, min: 0.35, max: 0.5, p50: 0.4, p75: 0.45, p95: 0.5, p99: 0.5, ratePerMinute: 0, windowSize: 5, recent: [] },
      std: { count: 5, mean: 0.11, min: 0.08, max: 0.14, p50: 0.1, p75: 0.12, p95: 0.13, p99: 0.14, ratePerMinute: 0, windowSize: 5, recent: [] },
      gap: { count: 5, mean: 0.18, min: 0.12, max: 0.24, p50: 0.17, p75: 0.2, p95: 0.23, p99: 0.24, ratePerMinute: 0, windowSize: 5, recent: [] },
    },
