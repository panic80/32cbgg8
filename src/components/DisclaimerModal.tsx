          ...
          <AlertDialogDescription className="text-left space-y-3 md:space-y-4 pt-3 md:pt-4 text-sm md:text-base">
            ...
            <div className="bg-amber-50 dark:bg-amber-950/50 border border-amber-200 dark:border-amber-800 rounded-md p-3 md:p-4 mt-3 md:mt-4">
              <p className="font-bold text-amber-900 dark:text-amber-100 text-sm md:text-base">
                CRITICAL: For all travel claims, entitlements, and policy interpretations, 
                you MUST verify the information with your Financial Services Administrator (FSA) 
                or consult official documentation before taking any action.
              </p>
            </div>
            
            <p className="text-xs md:text-sm text-muted-foreground mt-3 md:mt-4">
              This AI assistant is a supplementary tool only and should not be your sole source 
              for making financial or travel-related decisions.
            </p>
          </AlertDialogDescription>
        </AlertDialogHeader>
