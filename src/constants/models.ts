...
export const LLM_MODELS: LLMModel[] = [
  ...
  { id: 'gpt-5-mini', name: 'GPT-5 Mini', provider: 'openai', description: 'Next-generation efficient model with improved reasoning and cost-effectiveness' },
  { id: 'gpt-5-nano', name: 'GPT-5 Nano', provider: 'openai', description: 'Ultra-lightweight GPT-5 family model for rapid responses with excellent cost-efficiency' },
