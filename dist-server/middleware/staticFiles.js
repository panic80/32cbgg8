 ...
 */
export const findExistingPath = (paths) => {
 ...
 */
export const findDistPath = (dirname) => {
    const possiblePaths = [
 ...
 */
export const findLandingPath = (dirname) => {
    const possiblePaths = [
 ...
 */
const createHeadersSetter = () => (res, filePath) => {
 ...
 */
export const createFaviconHandler = (distPath) => (req, res) => {
 ...
 */
export const createProtectedStaticMiddleware = ({ distPath, requiresConfigAuth, requireAdminAuth, }) => {
 ...
 * @returns {Function} Express middleware
 */
export const createMimeTypeMiddleware = () => (req, res, next) => {
 ...
 * @returns {Function} Express route handler
 */
export const createSpaCatchAllHandler = ({ distPath }) => (req, res, next) => {
