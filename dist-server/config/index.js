...
export const createGatewayConfig = (overrides = {}) => {
    const { ENABLE_CACHE, CACHE_TTL, CACHE_CLEANUP_INTERVAL, ENABLE_RATE_LIMIT, RATE_LIMIT_MAX, RATE_LIMIT_WINDOW, RATE_LIMIT_BURST, ENABLE_LOGGING, LOG_LEVEL, LOG_DIR, RAG_SERVICE_URL, INGEST_TIMEOUT_MS, INGEST_MAX_RETRIES, INGEST_RETRY_DELAY_MS, MAPS_TIMEOUT, CANADA_CA_URL, MAX_RETRIES, REQUEST_TIMEOUT, RETRY_DELAY, HEALTH_CHECK_TIMEOUT_MS, PERFORMANCE_TIMEOUT_MS, PERFORMANCE_CACHE_MS, SOURCES_TIMEOUT_MS, SOURCES_STATS_TIMEOUT_MS, RAG_STREAM_TIMEOUT_MS, } = process.env;
    const baseConfig = {
