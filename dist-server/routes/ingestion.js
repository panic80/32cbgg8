...
const createIngestionRoutes = ({ rateLimiter, requireAdminAuth, validateIngestionUrl, getRagAuthHeaders, buildSseCorsHeaders, setSseHeaders, httpClient = axios, config = {}, }) => {
    const router = Router();
    ...
    router.post('/api/rag/ingest', requireAdminAuth, rateLimiter, validateIngestionPayload, controller.handleIngest);
    router.post('/api/v2/ingest', requireAdminAuth, rateLimiter, validateIngestionPayload, controller.handleIngest);
    router.post('/api/v2/ingest/canada-ca', requireAdminAuth, rateLimiter, controller.handleCanadaCaIngest);
