...
const createSupportRoutes = ({ rateLimiter, cache, config, processContent, geminiClient, openaiClient, anthropicClient, httpClient, }) => {
    const router = Router();
    ...
    router.post('/api/v2/followup', rateLimiter, validateRequest(followUpRequestSchema), controller.handleFollowUp);
